    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('os', models.CharField(max_length=64, verbose_name='系统名称')),
                ...
                ('network', models.ManyToManyField(to='vms.NetworkApaters')),
            ],
            options={
                'verbose_name': '虚拟机',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ctime', models.DateTimeField(default=datetime.datetime.now, verbose_name='创建时间')),
                ('utime', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('cluster', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vms.clustrs', verbose_name='集群')),
                ('datacenter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vms.datacenters', verbose_name='数据中心')),
                ('datastore', models.ManyToManyField(to='vms.DataStores', verbose_name='存储')),
                ('network', models.ManyToManyField(to='vms.NetworkApaters', verbose_name='网络')),
            ],
            options={
                'verbose_name': '宿主机',
                'verbose_name_plural': '宿主机',
                'db_table': 'innatehosts',
            },
        ),
        migrations.AddField(
            model_name='clustrs',
