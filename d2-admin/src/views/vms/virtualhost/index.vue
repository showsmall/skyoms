    ...
    return {
      table: {
        columns:[
          ...
          {label:'虚拟机名称',prop:'name',sort:false,},
          {label:'数据中心',prop:'datacenter',sort:false,},
          {label:'宿主机',prop:'ip',sort:false,},
          {label:'电源状态',prop:'powerState',sort:false,},
          {label:'CPU核数',prop:'cpunums',sort:false,},
          {label:'内存',prop:'memtotal',sort:false,},
          {label:'网络',prop:'network',sort:false,},
          {label:'系统',prop:'os',sort:false,},
          {label:'CPU用量',prop:'cpuusage',sort:false,},
          {label:'内存用量',prop:'memusage',sort:false,},
          {label:'存储用量',prop:'store_usage',sort:false,},
        ],
        data : [],
        size: 'mini',
        stripe: 'true',
