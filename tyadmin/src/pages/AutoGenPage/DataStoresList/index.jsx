...
import {addDataStores, queryDataStores, removeDataStores, updateDataStores} from './service';
...
const TableList = () => {
  ...
  try {
    await updateDataStores(value, current_id);
    hide();
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, {selectedRows}) => [
          ...
          <Input.Search style={{marginRight: 20}} placeholder="搜索存储 " onSearch={value => {
            setParamState({
              search: value,
            });
        ...
        request={(params, sorter, filter) => queryDataStores({...params, sorter, filter})}
