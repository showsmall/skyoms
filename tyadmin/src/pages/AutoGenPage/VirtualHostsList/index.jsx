...
import {addVirtualHosts, queryVirtualHosts, removeVirtualHosts, updateVirtualHosts} from './service';
import UpdateForm from './components/UpdateForm';
import UploadAvatar from '@/components/UploadAvatar';
import {queryDataCenters} from '@/pages/AutoGenPage/DataCentersList/service';import {queryNetworkAdapters} from '@/pages/AutoGenPage/NetworkAdaptersList/service';
...
const TableList = () => {
  ...
  try {
    await updateVirtualHosts(value, current_id);
    hide();
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, {selectedRows}) => [
          ...
          <Input.Search style={{marginRight: 20}} placeholder="搜索虚拟机 " onSearch={value => {
            setParamState({
              search: value,
            });
        ...
        request={(params, sorter, filter) => queryVirtualHosts({...params, sorter, filter})}
