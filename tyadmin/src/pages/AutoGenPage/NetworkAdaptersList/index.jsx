...
import {addNetworkAdapters, queryNetworkAdapters, removeNetworkAdapters, updateNetworkAdapters} from './service';
import UpdateForm from './components/UpdateForm';
import UploadAvatar from '@/components/UploadAvatar';
import {queryDataCenters} from '@/pages/AutoGenPage/DataCentersList/service';
...
const TableList = () => {
  ...
  try {
    await addNetworkAdapters({...fields});
    hide();
  ...
  try {
    await updateNetworkAdapters(value, current_id);
    hide();
  ...
  try {
    ...
    await removeNetworkAdapters(ids);
    hide();
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, {selectedRows}) => [
          ...
          <Input.Search style={{marginRight: 20}} placeholder="搜索网络端口 " onSearch={value => {
            setParamState({
              search: value,
            });
        ...
        request={(params, sorter, filter) => queryNetworkAdapters({...params, sorter, filter})}
