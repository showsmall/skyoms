...
import {addClusters, queryClusters, removeClusters, updateClusters} from './service';
...
const TableList = () => {
  ...
  try {
    await updateClusters(value, current_id);
    hide();
    ...
    <PageHeaderWrapper>
      <ProTable
        ...
        toolBarRender={(action, {selectedRows}) => [
          ...
          <Input.Search style={{marginRight: 20}} placeholder="搜索集群 " onSearch={value => {
            setParamState({
              search: value,
            });
        ...
        request={(params, sorter, filter) => queryClusters({...params, sorter, filter})}
